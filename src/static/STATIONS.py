STATIONS = [
    ...
    "Weißenohe",
    "Weißenthurm",
    "OberurselWeißkirchen/Steinbach",
    "Weißenhorn-Eschach",
    "Weiterstadt",
    "Weizern-Hopferau",
    ...
    "Bad Herrenalb",
    "Reichenbach(b. Ettlingen)",
    "Langensteinbach Bahnhof",
    "Ittersbach Bahnhof",
    "Ottenhöfen West",
    "Hamburg-Eidelstedt Zentrum",
    "Hamburg-Schnelsen",
    "Hamburg Burgwedel",
    "Bönningstedt",
    "Hasloh",
    ...
    "Fretzdorf",
    "Freyburg(Unstrut)",
    "Friedersdorf(Königs Wusterhausen)",
    "Friedewald(Kr Dresden) Bad",
    "Friedewald(Kr Dresden)Hp",
    "Friedrichroda",
    "Friedrichsruhe(Meck)",
    "Friedrichswalde(bei Eberswalde)",
    "Friesack(Mark)",
    "Frohburg",
    "Fürstenwalde Süd",
    "Gadebusch",
    ...
    "Chemnitz Schneeberger Straße",
    "Chemnitz Schule Altchemnitz",
    "Stollberg Schlachthofstraße",
    "Chemnitz Theaterplatz",
    "Chemnitz Treffurthstraße",
    "Chemnitz Uhlestraße",
    ...
    "Offenbach(Main) Marktplatz",
    "Offenbach(Main) Ledermuseum",
    ...
    "Mömbris-Strötzbach",
    "Durmersheim Nord",
    "Heilbronn Hauptbahnhof/Willy-Brandt-Pl.",
    "Heilbronn Harmonie",
    "Heilbronn Rathaus",
    "Heilbronn Neckar-Turm/K.-S.-Pl",
    "Wössingen Ost",
    "Alveslohe",
    "Ostersode",
    "Hütten",
    ...
    "Neuenbürg(Enz) Freibad",
    "Rotenbach(Enz)",
    "Neuenbürg(Enz) Eyachbrücke",
    "Höfen(Enz) Nord",
    "Calmbach Süd",
    "Bad Wildbad Nord",
    ...
    "Jakobwüllesheim",
    "Neuhausmühle",
    "Heilbronn Harmonie/Hafenmarktpassage",
    "Chemnitz Friedrichstraße",
    "Binsfeld",
    "Chemnitz Hbf (Bahnhofstraße)",
    "Chemnitz Annenstraße",
    "Heilbronn Harmonie/Kunsthalle",
    "Schömberg Stausee",
    "Heilbronn Technisches Schulzentrum",
    ...
    "Karlsruhe Entenfang",
    "Karlsruhe-Kniel. Rheinbergstr.",
    "Köln-Blumenberg",
    "Wörth(Rhein) Bürgerpark",
    "Wörth(Rhein) Bienwaldhalle",
    ...
    "Dreieich-Weibelfeld",
    "Wörth(Rhein) Rathaus",
    "Wörth(Rhein) Badallee",
    "Wörth(Rhein) Badepark",
    "Moosbachtal",
    "Tessin West",
    "Herzhorn",
    ...
    "Berlin Priesterweg",
    "Berlin Raoul-Wallenberg-Str.",
    "Berlin Rathaus Steglitz",
    "Berlin Savignyplatz",
    "Berlin Schichauweg",
    "Berlin Schönhauser Allee",
    "Berlin Springpfuhl",
    "Berlin Storkower Str",
    "Berlin Sundgauer Str",
    ...
    "Berlin Südende",
    "Berlin Westhafen",
    "Berlin-Hohenschönhausen (S)",
    "Berlin Beusselstraße",
    "Neuenburg(Baden)",
    "Berlin-Wedding",
    "Berlin Charlottenburg (S)",
    "Berlin-Schöneweide (S)",
    "Erkner (S)",
    "Berlin-Lichtenberg (S)",
    "Potsdam Hbf (S)",
    "Berlin Ostbahnhof (S)",
    "Blankenfelde (S)",
    "Strausberg (S)",
    ...
    "München Hbf Gl.5-10",
    "München Hbf (tief)",
    "Stolberg(Rheinl)Hbf Gl.27",
    "Stolberg(Rheinl)Hbf Gl.44",
    "Hamburg Hbf (S-Bahn)",
    "Hamburg-Altona(S)",
    "Spiegelau",
    "Lauter (Sachs)",
    ...
    "Peenemünde",
    "Unterlenningen",
    "Nürnberg Frankenstadion Sonderbahnsteig",
    "Weener",
